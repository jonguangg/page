...
<body bgcolor="black" leftmargin="0" topmargin="0" onload="init();" onScroll="moveVideoWindow();">
	<div id="bodys" style="position:absolute;top:0px;left:0px;width:100%;display:block;">
		...
		<div id="splash" style="position: absolute;left:0px;top:0px;width:1080px;height:1920px;background:url(img/null.png);background-size:100% 100%;display:block;z-index:99;">	
