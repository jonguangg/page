...
<head>
	...
	<script>
		...
		var userKey = getCookie("userKey")?parseInt(getCookie("userKey")):"9527";
		var groupId = getCookie("groupId")?parseInt(getCookie("groupId")):0;
		var channelPagePos = getCookie("channelPagePos")?parseInt(getCookie("channelPagePos")):0;
		var channelPos = getCookie("channelPos")?parseInt(getCookie("channelPos")):0;
		var channelCount = 0;
	...
	//	var channelPosTemp = channelPos;
		...
		function updateCookie() {
			setCookie("groupId", groupId, '1d'); 
			setCookie("channelPos", channelPos, '1d'); 
		}
		...
		function showSplash(){
			...
			var splashIndex = getCookie("splashIndex")?parseInt(getCookie("splashIndex")):0;
			splashIndex ++;
			if( splashIndex > splashArr.length-1 ){
				splashIndex = 0;
			}
			setCookie("splashIndex", splashIndex, '1d'); 
...
<div id="bodys" style="position:absolute;top:0px;left:0px;width:100%;display:block;">
	...
	<div id="detail" style="position:absolute;left:0px;top:0px;width:100%;z-index:2;background-color:black;display:none;">
		<div id="detaiPoster" style="position:relative;left:0%;top:0px;width:100%;height:500px;background:url(../loading.gif);background-size:100% 100% !important;" onclick="rePlay()">
			<!--video id="test_video" style="object-fit:fill" width="100%" height="100%" poster="img/null.png" autoplay controls preload="auto" src="http://cctvalih5ca.v.myalicdn.com/live/cctv1_2/index.m3u8" ></video-->	

			<video id="test_video" style="object-fit:fill" width="100%" height="100%" poster="img/null.png" autoplay controls preload="auto" src="http://cctvalih5ca.v.myalicdn.com/live/cctv1_2/index.m3u8" x5-playsinline playsinline="playsinline" webkit-playsinline x-webkit-airplay="true" x5-video-player-fullscreen="true" x5-video-orientation="landscape" >
			</vide>
		</div>
