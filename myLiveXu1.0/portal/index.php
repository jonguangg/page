...
<!-- 锁定图片 -->
<div id="lockImg" style="position:absolute;top:0px;left:0px;width:1280px;height:720px;background:url(img/lock.jpg);display:block;color: red; z-index:999;"></div>

<!-- 导入卡号及卡密 -->
<div id="cardKey" style="position:absolute;top:0px;left:0px;width:1280px;height:720px;background:url(img/cardKey.jpg);text-align:center;line-height:50px;display:none;">
	...
	<!-- 数字焦点图片 -->
	<div id="numBgImg" style="position: absolute;left:590px;top:305px;width:100px;height:100px;background: url(img/numBgImg.png); "></div>	
</div>

	<!-- 二维码 -->
	<div id="ewm" style="position:absolute;left:510px;top:260px;width:260px;height:265px;background:url(img/null.png);"></div>
