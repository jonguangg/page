...
#mysql5.7
docker exec -i mMysql /usr/bin/mysqldump myLive | gzip > $backupDir"myLive_docker"$time.sql.gz
...
#0 11 * * * /usr/local/web/www/myLive/backupMySQL5.7.sh
#0 11 * * * /home/admin/web/www/myLive/backupMySQL5.7.sh
